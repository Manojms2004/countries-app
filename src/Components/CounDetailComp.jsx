...
export default function CounDetailComp() {
  ...
  return (
    ...
    lodingAn ?
      ...
      <div className={`${getdeDark ? 'bg-black text-white' : 'bg-red'} h-[100vh] lg:w-screen lg:h-screen lg:flex lg:justify-center lg:items-center`}>
        <div>
          <Link to='/'>
          ...
          <div>
            <button onClick={callSetMode} className='border-blue-400 absolute top-4 right-6 bg-blue-500 text-white h-10 w-24  lg:h-10 lg:w-40 rounded-sm'>{getdeDark ? 'Light' : 'Dark'}</button>
          </div>
        </div>
        <div className='px-4 mt-20 lg:mt-0 lg:w-[80%] lg:h-[80%] lg:flex'>
          ...
          <div className='h-52 lg:w-[45%] lg:h-[50%] lg:flex lg:flex-col lg:items-center'>
            <h1 className='font-bold text-3xl'>South Georgio</h1>
            <div className='mt-4 relative left-0 lg:left-4 lg:h-[65%] w-[58%] flex flex-col justify-around'>
          ...
          <div className='lg:w-[45%] lg:h-[50%] lg:flex lg:justify-center'>
            <div className='mt-4 lg:mt-12 h-[50%] w-[60%] flex flex-col justify-around'>
